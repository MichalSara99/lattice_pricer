...
void testIndexedEuropeanBarrierCallOption2() {
	...
	std::cout << "European Barrier Down-and-Out call price:\n\n";
	...
	auto option = BarrierOptionBuilder<double>()
		...
		.withSpot(100.0).withStrike(100.0)
		.withPeriods(4).withVolatility(0.29144)
		.withBarrier(95.0).withRebate(1.0)
		.withBarrierType(BarrierType::DownAndOut)
		.build();
	...
	std::cout << "Call price lattice: \n";
	lattice_utility::print(callTree, callTree.cbegin(), callTree.cend());
	std::cout << "\n\nEuropean Barrier Down-And-Out call price: " << callTree.apex() << "\n";
...
void testIndexedEuropeanBarrierPutOption2() {
	...
	std::cout << "European Barrier Down-and-Out put price:\n\n";
	...
	std::cout << "Put price lattice: \n";
	lattice_utility::print(putTree, putTree.cbegin(), putTree.cend());
	std::cout << "European Barrier Down-And-Out put price: " << putTree.apex() << "\n";
...
void testIndexedEuropeanBarrierCallOption1DKEAdjust() {
	...
	std::cout << "European Barrier Up-and-Out call price (Derman-Kani-Ergener adjustment):\n\n";
	...
	pricer(callTree, stockTree, impliedProbsResult, dt, call_payoff,
		option.barrierType(), option.barrier(), option.rebate(), true);
...
void testIndexedEuropeanBarrierPutOption1DKEAdjust() {
	...
	std::cout << "European Barrier Up-and-Out put price (Derman-Kani-Ergener adjustment):\n\n";
...
void testIndexedEuropeanBarrierCallOption2DKEAdjust() {
	...
	std::cout << "European Barrier Down-and-Out call price (Derman-Kani-Ergener adjustment):\n\n";
...
void testIndexedEuropeanBarrierPutOption2DKEAdjust() {
	...
	std::cout << "European Barrier Down-and-Out put price (Derman-Kani-Ergener adjustment):\n\n";
...
void testIndexedEuropeanBarrierOptionPrice() {
	...
	testIndexedEuropeanBarrierCallOption1DKEAdjust();
	testIndexedEuropeanBarrierPutOption1();
	testIndexedEuropeanBarrierPutOption1DKEAdjust();
	testIndexedEuropeanBarrierCallOption2();
	testIndexedEuropeanBarrierCallOption2DKEAdjust();
	testIndexedEuropeanBarrierPutOption2();
	testIndexedEuropeanBarrierPutOption2DKEAdjust();
