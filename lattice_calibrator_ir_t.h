...
void testIndexedBKCalibration() {
	...
	// Instantiate Calibrator and launch it:
	hw_calibrator calibrator(discount_curve);
	auto result = calibrator(rateTree, bkm, dt);
...
void testIndexedBKSanityCheck() {
	...
	// this rate I picked up from previous calibartion procedure
	auto r{ calibratedTree.apex() };
	fwd_induction(rateTree, bkm, dt, r);
...
void testIndexedBK() {
	std::cout << "=======================================================\n";
	std::cout << "===== Indexed Black-Karasinski Model - TEST ===========\n";
	std::cout << "=======================================================\n";

	testIndexedBKCalibration();
	testIndexedBKSanityCheck();
...
void testBKCalibration() {
	...
	// Instantiate Calibrator and launch it:
	hw_calibrator calibrator(discount_curve);
	auto result = calibrator(rateTree, bkm, timeDeltas);
...
void testBKSanityCheck() {
	...
	// this rate I picked up from previous calibartion procedure
	auto r{ calibratedTree.apex() };
	fwd_induction(rateTree, bkm, timeDeltas, r);
...
void testBK() {
	std::cout << "=======================================================\n";
	std::cout << "======= Black-Karasinski Model - TEST =================\n";
	std::cout << "=======================================================\n";
