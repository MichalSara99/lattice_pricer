...
void createTwoVariableBinomialIndexedLattice() {
	...
	std::cout << "type of tree: " << typeid(lattice_structure::IndexedLattice<lattice_types::LatticeType::TwoVariableBinomial, double>::TreeType).name() << "\n";
...
void testIndexedLatticeCreation() {
	...
	createTwoVariableBinomialIndexedLattice();
...
void createTwoVariableBinomialLattice() {
	...
	lattice_structure::Lattice<lattice_types::LatticeType::TwoVariableBinomial, double, date>
		la = { today,today + date_duration(2),today,today + date_duration(1),today + date_duration(3) };
...
void testLatticeCreation() {
	...
	createTwoVariableBinomialLattice();
